class FillupsController < ApplicationController
  ...
  before_action :load_cars, only: [:new, :create, :edit, :update]
  ...
  private
    ...
    def fillup_params
      params.require(:fillup).permit(:date, :location, :number_of_gallons, :miles_since_last_fillup, :price_per_gallon, :car_id)
    end
end
